...
% Convert y into vector of 0's and 1's for multi-class classification
y_vec = zeros(m, num_labels); % 5000 x 10
for i = 1:m
   y_vec(i, y(i)) = 1;
end
...
for t = 1:m
   ...
   delta_2 = delta_2(2:end); % Take off bias unit data
   
   % delta_1 is not required becuase we don't compute error for input layer.
...
% Step 5
% Don't regularize 1st column of Theta1 which is used for bias term.
...
% Don't regularize 1st column of Theta2 which is used for bias term.
